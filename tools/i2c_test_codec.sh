...
csr i2c1_command  0x90 # START and send address
csr i2c1_status        # print status register (has a bit for ACK or NACK)
csr i2c1_txr      0x00 # data byte 1
csr i2c1_command  0x10 # send byte
csr i2c1_txr      0x00 # data byte 0
csr i2c1_command  0x10 # send byte
csr i2c1_txr      $[($addr<<1)+1] # address + read bit
csr i2c1_command  0x90 # RESTART and send address command
csr i2c1_command  0x20 # read with ACK
csr i2c1_rxr           # print first byte read
csr i2c1_command  0x68 # read with NACK and STOP
csr i2c1_rxr           # print second byte read
